...
describe('Pawn', function () {
    ...
    it("should not be able to move if at the end of the board - white", function() {
        ...
        const expected = [];
        whitePawnAtEnd.calculatePossibleMoves();
        assert.deepStrictEqual(whitePawnAtEnd.possibleMoves, expected)
    })
    ...
    it("should not be able to move if at the end of the board - black", function() {
        ...
        const expected = [];
        blackPawnAtEnd.calculatePossibleMoves();
        assert.deepStrictEqual(blackPawnAtEnd.possibleMoves, expected)
    })
});
